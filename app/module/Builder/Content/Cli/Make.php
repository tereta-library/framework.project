...
use Builder\Content\Model\Resource\Content\Collection as ContentCollectionModel;
...
class Make implements Controller
{
    ...
    public function make(): void
    {
        ...
        $contentModel = new ContentModel([
            ...
            'header' => 'Sample Home Page',
            'description' => 'This is a sample home content page short description',
        ...
        // Make a url rewrite
        $typeModel = PageTypeRepository::getInstance()->getType(ContentCollectionModel::class);
